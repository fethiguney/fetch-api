...
const renderCarDetails = (car) => {
	const { image, model, doors, seats, luggage, transmission, airConditioning, age, fuelType, pricePerHour  } = car;

	const strCar = `<div class="col-md-5">
                        <img src="https://carrental-v3-backend.herokuapp.com/files/display/${image[0]}" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-7">
                        <h1>${model}</h1>
                        <table class="table">
                            ...
                            <tr><td>Air condition</td><td>${airConditioning ? "✅" : "❎"}</td></tr>
